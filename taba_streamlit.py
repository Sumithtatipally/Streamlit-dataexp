...
def main():
	...
	if not file:
		...
		st.sidebar.write('Akash Topdar - 12120033')
		st.sidebar.write('Lalith Sharma - 12120091')
		st.sidebar.write('Prajukta Pradhan - 12120039')
		st.sidebar.write('Pranjal Kumar Srivastava - 12120023')
		st.sidebar.write('Sumith Tatipally - 12120043')
		return
	df = get_df(file)
